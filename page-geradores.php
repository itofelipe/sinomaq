<?php get_header(); ?>
<section class="title-prod title-prod-gerador">
	<h2>GERADORES</h2>
</section>
				...
				<div class="col-md-4 text-center">
						...
						<div class="prod-title">
							...
							<div class="botao-prod">
								...
								<a class="col-md-2" target="_blank" href="https://api.whatsapp.com/send?phone=5541991988808&amp;text=Olá%20eu%20gostei%20de%20um%20gerador"><i class="fa fa-shopping-cart" aria-hidden="true"></i></a>
								<div class="col-md-5"><hr></div>
							</div>
						</div>
				</div>
